libname master 'E:\Laura\Work\COGA\Projects\INT_EEG_SUNY\data\Phase_I_II_III\phaseII_coga_irpg_09_16_2015';
libname d 'E:\Laura\Work\COGA\Projects\INT_EEG_SUNY\data\ssagaII';
...
data tmp2; set master.allssaga2rv1;
	keep IND_ID DM1 DM4 DM8A AL6 AL17/* DM1 gender, 1 = male 2 = female; DM4 age; DM8A self reported race, see changes below to agree with SSAGAIV */
...
proc freq data=d.v21_int_ssaga23;
